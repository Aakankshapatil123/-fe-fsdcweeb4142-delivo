...
const Favorites = () => {
  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      ...
      try {
        ...
        console.log("MY FAVORITES:", response);
  ...
  const handleRemoveRestaurant = async (restaurantId) => {
    try {
      ...
      setFavorites((prev) =>
        prev.filter(
          (favorite) =>
            !(favorite.restaurant && favorite.restaurant._id === restaurantId),
        ),
      );
    } catch (error) {
      console.log(
  ...
  const handleRemoveMenu = async (menuId) => {
    try {
      ...
      setFavorites((prev) =>
        prev.filter(
          (favorite) => !(favorite.menu && favorite.menu._id === menuId),
        ),
      );
    } catch (error) {
      console.log(
  ...
  const menuFavorites = favorites.filter((favorite) => favorite.menu);
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 rounded-2xl bg-white px-6 py-20 text-center shadow-md">
            ...
            <p className="mt-2 text-gray-500">
              Save your favorite restaurants and menu items for quick access.
            </p>
            ...
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-gray-500">
                  ...
                  {restaurantFavorites.length !== 1 ? "s" : ""}
                </p>
              </div>
            </div>
                      ...
                      {menu.nutrition && (
                        <div className="mt-4 rounded-lg bg-gray-50 p-3">
                          ...
                          <div className="mt-2 grid grid-cols-2 gap-2 text-xs text-gray-600">
                            <span>
                              Calories: {menu.nutrition.calories ?? 0} kcal
                            </span>

                            <span>
                              Protein: {menu.nutrition.protein ?? 0} g
                            </span>

                            <span>
                              Carbs: {menu.nutrition.carbohydrates ?? 0} g
                            </span>
